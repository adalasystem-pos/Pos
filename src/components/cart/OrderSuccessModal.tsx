...
import { CheckCircle2, ShoppingBag, Clock, User, FileText, Printer } from 'lucide-react';
...
export const OrderSuccessModal: React.FC<OrderSuccessModalProps> = ({
  ...
  const orderTimeStr = new Intl.DateTimeFormat('en-GB', {
      ...
      footer={
        <div className="flex items-center justify-between gap-3 w-full">
          <Button
            ...
            variant="outline"
            onClick={handlePrint}
            className="gap-1.5 text-xs font-bold rounded-2xl print:hidden"
          >
          ...
          <Button
            ...
            variant="primary"
            onClick={onClose}
            className="bg-emerald-600 hover:bg-emerald-700 text-white font-black px-6 py-2.5 rounded-2xl custom-shadow text-sm"
          >
        ...
        <div className="p-4 bg-orange-50/50 rounded-3xl border-2 border-dashed border-orange-200 text-gray-800 space-y-3.5">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs text-gray-600 font-semibold pt-1">
            <div className="flex items-center gap-1.5">
              ...
              <span>کاتی فرۆشتن: {orderTimeStr}</span>
            </div>
